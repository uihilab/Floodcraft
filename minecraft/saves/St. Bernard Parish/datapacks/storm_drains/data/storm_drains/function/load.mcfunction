...
tellraw @a [{"text":"[Storm Drains] ","color":"gold"},{"text":"Storm Drain scavenger hunt datapack loaded successfully! Start button placed at 1209 -52 760 on sandstone wall.","color":"green"}]
