...
tellraw @a [{"text":"[Guide] ","color":"gold"},{"text":"We've reached the spillway gates. Interact with me so I can unlock the repairs and explain how to close the floodgates!","color":"white"}]
