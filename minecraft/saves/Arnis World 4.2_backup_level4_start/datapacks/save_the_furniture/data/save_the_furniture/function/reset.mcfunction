...
setblock 1314 -53 762 minecraft:smooth_quartz_stairs[facing=east,half=bottom,shape=straight,waterlogged=false] replace
setblock 1314 -53 763 minecraft:smooth_quartz_stairs[facing=east,half=bottom,shape=straight,waterlogged=false] replace
setblock 1315 -52 761 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1316 -52 761 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1315 -51 760 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1316 -51 760 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1315 -50 759 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1316 -50 759 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1315 -49 758 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1316 -49 758 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1315 -48 757 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace
setblock 1316 -48 757 minecraft:smooth_quartz_stairs[facing=north,half=bottom,shape=straight,waterlogged=false] replace

# Dry out other waterlogged decorations (soul lantern and blue candles)
setblock 1305 -52 760 minecraft:soul_lantern[hanging=false,waterlogged=false] replace
setblock 1309 -52 752 minecraft:light_blue_candle[waterlogged=false] replace
...
setblock 1310 -47 753 minecraft:bookshelf replace
setblock 1311 -47 753 minecraft:bookshelf replace
setblock 1314 -47 763 minecraft:bookshelf replace
setblock 1315 -47 763 minecraft:bookshelf replace
setblock 1316 -47 763 minecraft:bookshelf replace

# 3. Restore and empty the upstairs double chest at 1306 -47 757 / 758
setblock 1306 -47 757 minecraft:chest[facing=east,type=left,waterlogged=false] replace
setblock 1306 -47 758 minecraft:chest[facing=east,type=right,waterlogged=false] replace
...
# double beds
setblock 1310 -53 753 minecraft:light_blue_bed[facing=north,part=foot] replace
setblock 1310 -53 752 minecraft:light_blue_bed[facing=north,part=head] replace
setblock 1311 -53 753 minecraft:light_blue_bed[facing=north,part=foot] replace
setblock 1311 -53 752 minecraft:light_blue_bed[facing=north,part=head] replace

# other utilities
setblock 1306 -53 757 minecraft:lectern[facing=south] replace
setblock 1316 -53 758 minecraft:jukebox replace
setblock 1316 -53 759 minecraft:furnace[facing=west] replace
setblock 1311 -53 766 minecraft:crafting_table replace

# clear flower pot location (removed from game)
setblock 1308 -53 753 minecraft:air replace

# bookshelves
setblock 1316 -53 756 minecraft:bookshelf replace
setblock 1316 -52 756 minecraft:bookshelf replace
setblock 1316 -53 757 minecraft:bookshelf replace
setblock 1316 -52 757 minecraft:bookshelf replace
