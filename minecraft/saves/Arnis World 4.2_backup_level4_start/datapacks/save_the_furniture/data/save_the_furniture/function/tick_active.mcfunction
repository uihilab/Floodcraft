...
execute store result score #temp sf_score if items entity @a container.* minecraft:light_blue_bed
execute store result score #temp2 sf_score if items entity @a weapon.offhand minecraft:light_blue_bed
...
# --- 1. Beds in Chest ---
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:light_blue_bed
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:light_blue_bed
...
# --- 2. Books in Chest ---
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:book
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:book
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
# --- 3. Jukebox in Chest ---
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:jukebox
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:jukebox
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
# --- 4. Furnace in Chest ---
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:furnace
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:furnace
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:crafting_table
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:crafting_table
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:lectern
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:lectern
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:armor_stand
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:armor_stand
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
# --- 8. Helmet in Chest ---
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:diamond_helmet
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:diamond_helmet
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:diamond_chestplate
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:diamond_chestplate
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:diamond_leggings
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:diamond_leggings
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
# --- 11. Boots in Chest ---
execute store result score #temp_c sf_score if items block 1306 -47 757 container.* minecraft:diamond_boots
execute store result score #temp2_c sf_score if items block 1306 -47 758 container.* minecraft:diamond_boots
scoreboard players operation #temp_c sf_score += #temp2_c sf_score
...
# Stage 1: Y=-53 (Floor level) floods at 50s remaining (1000 ticks)
execute if score #time sf_timer matches 1000 run function save_the_furniture:spawn_water_y53
